    ...
    function AbstractProxy(target) {
        ...
        var handler = {
            ...
            defineProperty: function (target, key, desc) {
                ...
                switch (typeof desc.value) {
                    case "object": {
                        ...
                        var deepCopiedProxy = _1.deepCopyRecordToProxy(desc.value !== null ? desc.value : {});
                        ...
                        if (key in thisAbstractProxy.$postUpdateCallbacksOn) {
                            for (var _i = 0, _a = Object.keys(thisAbstractProxy.$postUpdateCallbacksOn[key]); _i < _a.length; _i++) {
                    ...
                    case "boolean": {
                        ...
                        if (key in thisAbstractProxy.$postUpdateCallbacksOn) {
                            for (var _b = 0, _c = Object.values(thisAbstractProxy.$postUpdateCallbacksOn[key]); _b < _c.length; _b++) {
                                var f = _c[_b];
                                f(desc.value);
                            }
                        }
            ...
            deleteProperty: function (target, key) {
                if (key in thisAbstractProxy.$postUpdateCallbacksOn) {
                    for (var _i = 0, _a = Object.values(thisAbstractProxy.$postUpdateCallbacksOn[key]); _i < _a.length; _i++) {
                        var callback = _a[_i];
                        callback(null);
                    }
                }
